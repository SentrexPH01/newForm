...
const onSubmit = async (values, { setSubmitting }) => {
  try {
    // Uncomment the code below to make the SharePoint API request
    /*
    ...
    */
    ...
    // Uncomment the code below to generate a PDF using html2pdf
    /*
    ...
    */
    ...
    // Uncomment the code below to invoke the NewFormTitle function
    // await NewFormTitle();
  } catch (error) {
